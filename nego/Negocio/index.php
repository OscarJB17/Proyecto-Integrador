...
<body>
  ...
  <div class="container-fluid" style="padding-top: 230px;">
    <div class="row" style="background-color: pink; text-align:center;">
      <div class="col" style="background-color: #3bd5f0 ; padding-top: 80px;">
        <img src="Cliente/Recursos/logocel.png" height="220px" width="220px">
      </div>
      <div class="col" style="background-color:#d56bfa;">
        <div class="row">
          <h1 style="color: #343a40;">Oscar Jimenez Bañuelos 123</h1>
          <h1 style="color: #343a40;">Antonio</h1>
          <h1 style="color: #343a40;">Holaaa</h1>
